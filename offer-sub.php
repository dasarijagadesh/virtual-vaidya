    ...
    <div class="container-fluid">
        <div class="row back-icon">
            <div class="col-12 d-flex pt-2 justify-content-between">
                <a href="at-home.php" class="d-flex">
                    ...
                    <p class="pl-2"> Basic Womens's Health Checkup</p>
        ...
        <div class="row mt-2 mb-2">
            <div class="col-md-6 padding-sub-i">
                <img src="Assets/images copy/doctor 2.jpg" alt="" class="w-100">
            </div>
            <div class="col-md-6 mt-2 mb-2">
                <h4>Basic Women's Health Checkup</h4>
                <p class="desc-p">Ideal for women aged <span>21-40 Years</span></p>
                <p class="desc-p">Includes<span>33 tests</span></p>
                <div class="d-flex justify-content-between box-to-now">
                    <p>&#8377;899 <del class="del-12"> &#8377;1200</del> <span class="clr-s1">25% Off</span></p>
