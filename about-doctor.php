...
<section class="padding-conson">
    <div class="container-fluid">
        ...
        <div class="row card-doctor-a">
            ...
            <div class="col-5 ">
                <img src="assets/images copy/gyna.jpg" alt="" class="img-doctoras">
            </div>
            <div class="col-7 font-mb-p">
                ...
                <p class="font-pdoctor"><i class="fas fa-globe globe-font"></i> English,Hindhi</p>

            </div>
            <div class="col-12">
                <p class="exp-px">11 years experiance overall</p>
            </div>
        ...
        <div class="row mt-2 mb-2">
            <div class="col-12">
                ...
                <div class="d-flex descrption-ph">
                    ...
                    <div>
                        <h6>Detailed Treatment Explanation</h6>
                        <p>90% patients find the doctors friendly and approachable</p>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12 d-flex justify-content-between">
                <button class="recomonded-button"><i class="fas fa-share-alt pr-2"></i> Recommend</button>
                <button class="consult-nowb"> Consult now</button>
            </div>
        </div>
